...
public class Controller
{
    ...
    private void loginCheck( boolean isManager)
    {
        ...
        while(inputID == 0)
        {
            ...
            {
                printMessageToView("Only numbers are accepted.\nEnter your ID.");
            }
        }
        ...
        if( rStaff != null)//User data is found
        {
            ...
            if( rStaff.getClass().getName().equalsIgnoreCase(searchClassName))
            {
                ...
                {
                    printMessageToView("Wrong Password.");
                }
            }
        ...
        while(!done)
        {
            ...
            if(key.equalsIgnoreCase("Y"))
            {
                ...
                try
                {
                    ...
                    printMessageToView("New staff information was added.");
                    done = true;
                }
    ...
    private void deleteStaff()
    {
         ...
         while(inputNumber == 0)
        {
            try
            {
                ...
                if(!key.equalsIgnoreCase("Y"))
                {
                    printMessageToView("The transaction has been canceled.");
                    pause(2);
                    scene = SCENE_MAIN_MENU;
                    return;
                }
            ...
            {
                printErrorMessageToView("ID must be valid a number. Input again:");
                key = cView.userInput();
            }
        }
    }
    ...
    private void selectOrderMenu()
    {
        ...
        while(inputNumber == 0)
        {
            ...
            try
            {
                ...
                {
                    inputNumber = 0;
                    printErrorMessageToView("Choose from 1 to 5:");
                    pause(2);
                }
            }
            catch(Exception e)
        ...
        switch(inputNumber)
        {
            ...
            break;
            default:
                printErrorMessageToView("This line must not be executed!! Check program of selectOrderMenu()");
                key = cView.userInput();
            break;
        }
    }
    ...
    private void updateOrder()
    {
        ...
        if( currentUserID != rOrder.getStaffID())
        {
            ...
            printMessageToView("(This order belongs to " + rOrder.getStaffName() + ")");
            pause(2);
            return;    
        }
    ...
    public void deleteOrderItem(int orderID)
    {
        ...
        if( currentUserID != rOrder.getStaffID())
        {
            printErrorMessageToView("You are not eligible to delete this order.");
            printMessageToView("(This order belonges to " + rOrder.getStaffName() + ")");
            pause(2);
            return;    
        }
        ...
        while(!done)
        {
            ...
            {
                printErrorMessageToView("Enter a valid integer.");
                pause(2);
            }
        }
    }
    ...
    private void closeOrder()
    {
        ...
        {
            printMessageToView("This order is already closed or canceled.");
            pause(2);
            return;
        }
        
        printMessageToView("Are you sure you want to close this order?(YES:y)");
        String key = cView.userInput();
        
        if(key.equalsIgnoreCase("Y"))//back to previous menu
        {
            cDatabase.closeOrder(closeOrderID);
            printMessageToView("The order has been closed.");
            pause(2);
        }
    }
    ...
    private void cancelOrder()
    {
        ...
        if(key.equalsIgnoreCase("Y"))//back to previous menu
        {
            ...
            printMessageToView("This order has been canceled.");
            pause(2);
        }
    }
    ...
    private void chooseEditMenuItemMode()
    {
        ...
        printMessageToView("Choose a number:");
        key = cView.userInput();
        ...
        while(inputNumber == 0)
        {
            try
            {
                ...
                switch(inputNumber)
                {
                    ...
                    break;
                    default:
                        printMessageToView("Choose from 1 to 3:");
                        key = cView.userInput();
                    break;
                }
            }
    ...
    private int generateMenuID()
    {
        ...
        while(newID == 0)
        {
            ...
            try
            {
                ...
                if(newID > 9999)
                {
                    printMessageToView( "Please enter a number below 10000");
                    key = cView.userInput();
                    newID = 0;
                }
                else
    ...
    private void addNewMenuItem()
    {
        ...
        while(!done)
        {
            ...
            while(newType == 0)
            {
                ...
                {
                    printMessageToView(" Please Enter a valid number:"); 
                    key = cView.userInput();
                }
            }
