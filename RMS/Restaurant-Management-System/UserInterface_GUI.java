...
public class UserInterface_GUI extends JFrame implements ActionListener
{
    ...
    public UserInterface_GUI(Controller_GUI rController)
    {
        ...
        // Set frame
        setTitle("Marthely Restaurant Management System");
    ...
    private void createMasterPanelConpornents()
    {
        ...
        headTitle = new JLabel("Marthely Restaurant Management System");
    ...
    private int getIDfromString(String stringLine, int length)
    {
        ...
        if(index == -1)
        {
            showErrorDialog("Error", "String 'ID:' doesn't exist");
            return -1;
        }
    ...
    *****************************************************************/
    private class LoginPanel extends JPanel implements ActionListener
    {
        ...
        public LoginPanel()
        {
            ...
            chbIsManager = new JCheckBox("Login as a manager");
            gbc.gridx = 0;
            gbc.gridy = 2;
            gbc.gridwidth = 2;
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnOK)
            {
                ...
                {                   
                    ...
                    showConfirmDialog("Message", "New menu item added !");
                }
                init(menuItemID);
            }
        }
    ...
    private class EmployeeListPanel extends JPanel implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            else if (ae.getSource() == btnDeleteStaff)
            {
                ...
                if( showYesNoDialog("", "Delete this staff?") == DIALOG_YES)
                {
            ...
            else if (ae.getSource() == btnClockOut)
            {
                ...
                {
                    displayMessage("This staff has been clocked out.");
                    init();
                }
            }
        }
    ...
    private class EditEmployeePanel extends JPanel implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnOK)
            {
                ...
                {
                    displayErrorMessage("Please fill every form !");
                    return;
                }
                ...
                else
                {
                    ...
                    showConfirmDialog("Message", "A new staff has been added successfully !");
    ...
    *****************************************************************/       
    private class OrderListPanel extends JPanel implements ActionListener
    {
        ...
        private String getSelectedOrderStaffName()
        {
            ...
            if(index == -1)
            {
                showErrorDialog("Error", "String 'Name:' can't be found !");
                return null;
            }
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            else if (ae.getSource() == btnCloseOrder)
            {
                ...
                if( showYesNoDialog("Close order","Are you sure you want to close this order?") == DIALOG_YES)
                {
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnAddItem)
            {
                ...
                if (btnAddItem.getVerifyInputWhenFocusTarget()) {
                    ...
                    if (!btnAddItem.hasFocus()) {    //The components have not been verified
                        return;
                    }
                }  
    ...
    *****************************************************************/   
    private class TotalSalesPanel extends JPanel implements ActionListener
    {
        ...
        public TotalSalesPanel()
        {
            ...
            btnCloseAllOrder    = new JButton("Close all orders");
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnPrint)
            {
                ...
                if( createFineName == null)
                    ...
                    displayMessage(createFineName + " has been generated.");
            }
            else if (ae.getSource() == btnCloseAllOrder)
            {
                if (showYesNoDialog("", "Are you sure to close all orders?") == DIALOG_YES)
                {
    ...
    *****************************************************************/   
    private class PaymentPanel extends JPanel implements ActionListener
    {
        ...
        public PaymentPanel()
        {
            ...
            btnAllClockOut = new JButton("Clock out all staff");
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            {
                if (showYesNoDialog("", "Are you sure to clock out all staff?") == DIALOG_YES)
                {
        ...
        @Override public boolean verify(JComponent c)
        {
            ...
            try
            {
                ...
                switch(state)
                {
                  ...
                  displayErrorMessage("Only numbers are allowed.");
                  textField.setBackground( Color.red );
                result = false;
            }
            return result;
