...
public class Controller_GUI
{
    ...
    public boolean deleteStaff(int id)
    {
        ...
        if(rStaff == null)
        {
            setErrorMessage("StaffID:" + id + " can't be found.");
            return false;
        }
    ...
    public boolean clockOut(int staffID)
    {
        ...
        switch(state)
        {
            ...
            case Staff.WORKSTATE_FINISH:
                ...
                break;
           default:
                setErrorMessage("Staff:" + rStaff.getFullName() + "didn't work today");
                break;
        }
    ...
    public boolean deleteMenuItem(int id)
    {
        ...
        if(rMenuItem == null)
        {
            setErrorMessage("Menu item ID:" + id + " can't be found.");
            return false;
        }
    ...
    public boolean addNewOrderItem(int orderID, int addItemID, byte addItemQuantity)
    {
        ...
        {
            setErrorMessage("You are not allowed to edit this order \nThis order belongs to " + rOrder.getStaffName() + ")");
        ...
        if(rNewItem == null)
        {
            setErrorMessage("MenuID[" + addItemID + "]can't be found.");
    ...
    public boolean deleteOrderItem(int orderID, int deleteNo)
    {
        ...
        if( currentUserID != rOrder.getStaffID())
        {
            setErrorMessage("You can't delete this order .\nThis order belongs to " + rOrder.getStaffName() + ")");
    ...
    public boolean closeOrder(int closeOrderID)
    {
        ...
        if( currentUserID != rOrder.getStaffID())
        {
            setErrorMessage("You are not allowed to delete this order.\n(This order belongs to " + rOrder.getStaffName() + ")");
            return false;    
        }
        
        if(rOrder.getState() != 0)
        {
            setErrorMessage("This order is already closed or canceled.");
            return false;
        }
     ...
     **********************************************************/
     public String generateSalesReport()
     {
        ...
        {
             setErrorMessage("All orders must be closed or canceled before generating reports.");
             return null;
        }
    ...
    public String generatePaymentReport()
    {
        ...
        {
            setErrorMessage("All staff must be checked out before generating a payment report.");
            return null;
        }
